<footer class="ftco-footer ftco-bg-dark ftco-section img" style="background-image: url(<?php echo base_url();?>assets/images/bg_2.jpg); background-attachment:fixed;">
