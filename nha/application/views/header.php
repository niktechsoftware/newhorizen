...
<title>New Horizon Academy</title>
<meta charset="utf-8">
...
<div class="container">
<a class="navbar-brand text-primary" href="<?php echo base_url();?>index.php/welcome"><i class="flaticon-university"></i>NEW HORIZON<br><small>ACADEMY</small></a>
...
<li class="nav-item active"><a href="<?php echo base_url();?>index.php/welcome" class="nav-link">Home</a></li>
<li class="nav-item active"><a href="<?php echo base_url();?>index.php/welcome/about" class="nav-link">About</a></li>
